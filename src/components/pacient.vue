                    ...
                    <b-row>
                        <b-col md="4">
                            <b-form-group id="input-group-1" label="Edad:" label-for="input-1">
                                <b-form-input id="input-1" v-model="form.age" type="number" required placeholder="Edad"></b-form-input>
                            </b-form-group>
                        </b-col>
                    </b-row>
                </b-container>
                    ...
                    <b-row>
                        <b-col md="4">
                            <b-form-group label="¿Presenta bultos en los senos?">
                                <b-form-radio-group id="radio-group-1" v-model="form.sLump" :options="options" name="sintoma1"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                        <b-col md="4">
                        ...
                        <b-col md="4">
                            <b-form-group label="¿Presenta hundimiento en los senos/pezones?">
                                <b-form-radio-group id="radio-group-3" v-model="form.sSinking" :options="options" name="sintoma3"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                    </b-row>
                    <b-row>
                        <b-col md="4">
                            <b-form-group label="¿Presenta secreción?">
                                <b-form-radio-group id="radio-group-4" v-model="form.sSecretion" :options="options" name="sintoma4"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                        <b-col md="4">
                        ...
                        <b-col md="4">
                            <b-form-group label="¿Presenta dolor en los senos?">
                                <b-form-radio-group id="radio-group-6" v-model="form.sPain" :options="options" name="sintoma6"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                    </b-row>
                </b-container>
                    ...
                    <b-row>
                        <b-col md="6">
                            <b-form-group label="¿Su primera menstruación fue antes de los 12 años?">
                                <b-form-radio-group id="radio-group-7" v-model="form.rMenstruation" :options="options" name="factor1"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                        <b-col md="6">
                    ...
                    <b-row>
                        <b-col md="6">
                            <b-form-group label="¿Presenta mamas densas?">
                                <b-form-radio-group id="radio-group-9" v-model="form.rDenseBreast" :options="options" name="factor3"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                        <b-col md="6">
                            <b-form-group label="¿Ha recibido radioterapia?">
                                <b-form-radio-group id="radio-group-10" v-model="form.rRadiotherapy" :options="options" name="factor4"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                    </b-row>
                    <b-row>
                        <b-col md="6">
                            <b-form-group label="¿Presenta mutación en el gen BRCA1 o BRCA2?">
                                <b-form-radio-group id="radio-group-11" v-model="form.rMutation" :options="options" name="factor5"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                        <b-col md="6">
                            <b-form-group label="¿Ha tenido cáncer con anterioridad?">
                                <b-form-radio-group id="radio-group-12" v-model="form.antCancer" :options="options" name="factor6"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                    </b-row>
                    <b-row>
                        ...
                        <b-col md="6">
                            <b-form-group label="¿Algún familiar de primer grado ha sido diagnosticado con cáncer?">
                                <b-form-radio-group id="radio-group-14" v-model="form.antRelative" :options="options" name="factor8"></b-form-radio-group>
                            </b-form-group>
                        </b-col>
                    </b-row>
                </b-container>
